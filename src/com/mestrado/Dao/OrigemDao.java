...
public class OrigemDao {
	...
	public void salvar(String descricao, String sigla) throws Exception {
		...
		JOptionPane.showMessageDialog(null,
				"Clinica de Origem Salva com sucesso!!!");
	}
	...
	public void alterar(Origem origem) {
		...
		JOptionPane.showMessageDialog(null,
				"Clinica de Origem alterada com sucesso!!!");
	...
	public Origem buscar(String a, String b) {
		...
		Query query = em
				.createQuery(" select a from Origem a where a.sigla = :Sigla");
	...
	public List<Origem> buscaTodos(String a, String b) {
		Query query = em.createQuery("select a from Origem a");
		List<Origem> result = query.getResultList();
		return result;
	}
