...
public class CadPlanejamentoView extends JFrame {
	...
	public CadPlanejamentoView() {
		...
		cmbOrigem
				.setModel(new DefaultComboBoxModel(new String[] { "", "CCP",
						"URO", "PNM", "HEMATO", "GO", "PROCTO", "PEDIATRIA",
						"ORTOP" }));
		...
		cmbAprovPlano.setModel(new DefaultComboBoxModel(new String[] {
				"N\u00E3o", "Sim" }));
		...
		cmbBlocos.setModel(new DefaultComboBoxModel(new String[] { "N\u00E3o",
				"Sim" }));
