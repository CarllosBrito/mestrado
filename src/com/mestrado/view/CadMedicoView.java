				...
				if (txtNomeMed.getText().trim().equals("")
					...
					JOptionPane
							.showMessageDialog(null,
									"Favor digitar todos os dados para salvar médico!!");
				} else {
					...
					if (NomeMD == null || NomeMD.trim().equals("")) {
						...
						try {
							...
							JOptionPane
									.showMessageDialog(null,
											"CRM Já existe favor verificar e tentar novamente!!");
							limpar();
						}
					}
				}
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txtNomeMed.getText().trim().equals("")
					...
					JOptionPane
							.showMessageDialog(null,
									"Necessário realizar a busca para realização da alteração!");
				} else {
					MedicoDao mdDao = new MedicoDao();
