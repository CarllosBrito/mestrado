...
public class CadRegAnatomicaView extends JFrame {
	...
	public CadRegAnatomicaView() {
		...
		txtDescricao
				.setToolTipText("Digite o Nome da Regi\u00E3o anat\u00F4mica");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (descricao == null || descricao.trim().equals("")) {
					...
					try {
						dao.salvar(regiao);
						JOptionPane.showMessageDialog(null,
								"Região Anatômica salva com sucesso!!!");
						Limpar();
					} catch (Exception e) {
						JOptionPane
								.showMessageDialog(null,
										"Região existente, favor verificar e tentar novamente!!");
					}
		...
		btnSalvar.setIcon(new ImageIcon(CadRegAnatomicaView.class
		...
		btnAlterar.setIcon(new ImageIcon(CadRegAnatomicaView.class
		...
		btnBuscar.setIcon(new ImageIcon(CadRegAnatomicaView.class
		...
		btnSair.setIcon(new ImageIcon(CadRegAnatomicaView.class
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(
				...
				gl_contentPane
						...
						.addComponent(txtCodRegAnatomica,
								GroupLayout.PREFERRED_SIZE,
								GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGap(18)
						.addComponent(lblDescrio, GroupLayout.PREFERRED_SIZE,
