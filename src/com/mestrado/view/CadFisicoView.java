	...
	public CadFisicoView() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txtNomeFisico.getText().trim().equals(null)
						|| txtABFM.getText().trim().equals("")
						|| txtUserSigla.getText().trim().equals("")) {
					...
					try {
						...
						JOptionPane
								.showMessageDialog(null,
										"Físico, já existe, Favor verificar e tentar novamente!");
					}
		...
		btnSalvar.setIcon(new ImageIcon(CadFisicoView.class
				.getResource("/imagens/1482301942_Save_Icon.png")));

		JButton btnAlterar = new JButton("");
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (txtNomeFisico.getText().trim().equals("")
						|| txtUserSigla.getText().trim().equals("")) {
					JOptionPane.showMessageDialog(null,
							"O Favor preencher todos os Campos!!");
				} else {
					...
					if (abfm == null || abfm.trim().equals("")) {
						JOptionPane.showMessageDialog(null,
								"O Favor preencher o Campo ABFM!!");
					} else {
		...
		btnAlterar.setIcon(new ImageIcon(CadFisicoView.class
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (abfm == null || abfm.trim().equals("")) {
					JOptionPane.showMessageDialog(null,
							"Favor digitar um ABFM Inválido!!");
				} else if (abfm.trim().equals(objBusca.getABFM())) {
		...
		btnLimpar.setIcon(new ImageIcon(CadFisicoView.class
